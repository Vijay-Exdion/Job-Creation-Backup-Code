    ...
    while True:
        ...
        while retry < MAX_RETRIES:
            ...
            try:
                ...
                logger.info("Activities clicked")
                ...
                break
                    ...
                    retry += 1
                    logger.info(f"Error at row {row} retry {retry}: {e}")
